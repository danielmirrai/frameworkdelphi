...
uses
  ...
  uDMException, uFormViewSearchModel, uFormAddModelCustom,
...
type
  ...
  public
    ...
    class function CreateComponent(const poClasse: TClassFormViewModel;
      ...
      : TComponent; Overload;                     
    class function CreateComponent(const poClasse: TClassFormAddModelCustom;
      poOwner: TComponent = nil) : TComponent; Overload;            
    class function CreateComponent(const poClasse: TClassFormViewSearchModel;
...
class function TFactoryObject.CreateComponent(const poClasse: TClassFormViewSearchModel; poOwner: TComponent;
  poObjectAction: TObjectAction): TComponent;
begin
  Result := nil;
  if Assigned(poClasse) then           
    Result := poClasse.Create(poOwner, sCST_EmptyStr, poObjectAction);
end;

class function TFactoryObject.CreateComponent(const poClasse: TClassFormAddModelCustom; poOwner: TComponent): TComponent;
begin
  Result := nil;
  if Assigned(poClasse) then
    Result := poClasse.Create(poOwner);
