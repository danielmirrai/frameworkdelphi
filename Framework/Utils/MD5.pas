...
function MD5String2(const S: string): string; Overload;
function MD5String2(const S: TStringList): string; Overload;
...
function MD5String2(const S: string): string;
begin
